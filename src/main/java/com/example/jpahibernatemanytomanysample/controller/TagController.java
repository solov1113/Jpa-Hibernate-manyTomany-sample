package com.example.jpahibernatemanytomanysample.controller;

import com.example.jpahibernatemanytomanysample.exception.ResourceNotFoundException;
import com.example.jpahibernatemanytomanysample.model.Tag;
import com.example.jpahibernatemanytomanysample.model.Tutorial;
import com.example.jpahibernatemanytomanysample.respository.TagRepository;
import com.example.jpahibernatemanytomanysample.respository.TutorialRepository;
...
public class TagController {
    ...
    public ResponseEntity<Tag> addTag(@PathVariable("tutorialId") Long tutorialId, @RequestBody Tag tagRequest) {
        ...
        }).orElseThrow(()-> new ResourceNotFoundException("Not fond Tutorial with id = " + tutorialId));
